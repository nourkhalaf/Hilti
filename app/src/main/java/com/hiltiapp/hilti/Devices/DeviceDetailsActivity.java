    ...
    private void checkOrderState()
    {
        ...
        ordersRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot)
            {
                if(snapshot.exists())
                {
                    Toast.makeText(DeviceDetailsActivity.this,getString(R.string.cart_label),Toast.LENGTH_SHORT).show();
                                ...
                                cartListRef.child("Admin View").child("Products").child(deviceProductId)
                                        ...
                                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                ...
                                                if (task.isSuccessful()) {
                                                    Toast.makeText(DeviceDetailsActivity.this, getString(R.string.toast_added_to_cart), Toast.LENGTH_SHORT).show();
