...
public class WoodDetailsActivity extends AppCompatActivity {
    ...
    private void checkOrderState()
    {
        ...
        ordersRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot)
            {
                if(snapshot.exists())
                {
                    Toast.makeText(WoodDetailsActivity.this,getString(R.string.cart_label),Toast.LENGTH_SHORT).show();
        ...
        WoodProductsRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot)
            {
                if(snapshot.exists())
                {
                    ...
                    woodPrice = snapshot.child("price").getValue().toString();
    ...
    private void addToCart()
    {
        ...
        totalPrice = ((Integer.valueOf(woodPrice))) + Integer.valueOf(woodExtraPrice);
                            ...
                            cartListRef.child("Admin View").child("Products").child(woodProductId)
                                    ...
                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            ...
                                            if(task.isSuccessful())
                                            {
                                                Toast.makeText(WoodDetailsActivity.this,getString(R.string.toast_added_to_cart),Toast.LENGTH_SHORT).show();

//                                                Intent intent = new Intent(WoodDetailsActivity.this , ScreensProductsActivity.class);
