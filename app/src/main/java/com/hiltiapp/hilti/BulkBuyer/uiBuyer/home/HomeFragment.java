package com.hiltiapp.hilti.BulkBuyer.uiBuyer.home;
...
import com.hiltiapp.hilti.BulkBuyer.BulkDevices.DeviceCategoriesActivity;
import com.hiltiapp.hilti.BulkBuyer.BuyerScreens.ScreensProductsActivity;
import com.hiltiapp.hilti.BulkBuyer.BuyerSkins.SkinsProductsActivity;
import com.hiltiapp.hilti.BulkBuyer.BuyerWoodDesigns.WoodCategoriesActivity;
...
public class HomeFragment extends Fragment {
    ...
    private LinearLayout active_layout, not_active_layout;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View root = inflater.inflate(R.layout.fragment_bulk_home, container, false);
        ...
        not_active_layout = root.findViewById(R.id.not_active_layout);

        UsersRef = FirebaseDatabase.getInstance().getReference().child("Users").child(Prevalent.currentBuyer.getPhone());
        ...
        UsersRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot)
            {
                if(snapshot.exists())
                {
                    ...
                    assert buyer != null;
                    if (buyer.getState().equals("notActive"))
                    {
                        not_active_layout.setVisibility(View.VISIBLE);
                        active_layout.setVisibility(View.GONE);
                     }
                    else if (buyer.getState().equals("active"))
                    {

                        not_active_layout.setVisibility(View.GONE);
